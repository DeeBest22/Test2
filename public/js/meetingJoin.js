      ...
      class ParticipantMeeting {
        ...
        updateGridSizeClass() {
          ...
          videoContainer.classList.remove(
            ...
            'participants-8', 'participants-9', 'participants-11', 
            'participants-12', 'participants-13', 'participants-14'
          );
          
          // Add appropriate size class based on participant count
          ...
          // For 10 or 15+ participants, use default grid (no special class)
        }
